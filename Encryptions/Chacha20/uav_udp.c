// Server 1 (uav_udp) with circular buffer nonce storage
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
#define KEY_FILE "session_key.bin"    // Path to the session key file
...
int main() {
    ...
    printf("Server 1 listening on ports %d (from PX4), %d (to Server 2), and %d (return from server 2)\n", PORT1, SERVER2_PORT, PORT2);
